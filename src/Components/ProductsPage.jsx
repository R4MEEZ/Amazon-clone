...
import "../Components/Services/ProductsPage.css";
...
function Products() {
  ...
  return (
    <div className="about-page">
      <h1 className="text-center fs-1 my-3">Products</h1>
      <div className="cards d-flex justify-content-center flex-wrap gap-4 ">
